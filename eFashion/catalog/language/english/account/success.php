<?php
// Heading
$_['heading_title'] = 'Your account is active! ';

// Text
$_['text_message']  = '<p>Congratulations, and welcome to our family! If you have ANY questions about the operation of your account, please <a href="index.php?route=information/contact">eFashion support</a> .</p> <p>A confirmation has been sent to the provided e-mail address. If you have not received it within the hour, please <a href="%s">contact us</a>.</p>';
